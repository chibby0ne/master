...
public:
    ...
    /// Number of edges that server as threshold to decide whether or not to split row 
    Param<unsigned int> edges_threshold;
...
protected:
	...
	void Set_Default_Values()
	{
        ...
        edges_threshold.Init(7, "edges_threshold", param_list_);
